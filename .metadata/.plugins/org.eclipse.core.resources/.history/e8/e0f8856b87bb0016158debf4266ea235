...
public class Bullet extends MovingObjects{
	...
	/* WHAT IT DOES: Constructor for Bullet class
	 * PARAMETERS: 
	 * 	posx - position x
	 * 	posy - position y
	 * 	type - type of bullet to spawn
	 * RETURN:*/
	...
	/* WHAT IT DOES: Calculates the prximity from  
	 * PARAMETERS: 
	 * RETURN:*/
...
//		g2.fillRect((int) -width/2, (int) -height/2, (int) width, (int) height);
	...
	/* WHAT IT DOES: Getter method for the ammo's hitbox 
	 * PARAMETERS: NONE
	 * RETURN: Rectangle2D.Double object of the ammo's hitbox*/
