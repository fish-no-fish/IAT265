...
{
	private SGPump pump; // the pump of the gun that will handle display and logic
	private boolean gunPumped; //stores the status of whether the gun is currently pumped back
	private boolean chambered; //stores the status of whether the gun is chambered with a bullet
	private Rectangle2D.Double chamber; //the hitbox of the chamber slot
	private boolean emptyShell; //stores the status of whether the gun contains an empty shell to eject
	private Bullet tempEjection; //draws the image of a temporary bullet just before it's ejected
...
//			GunRangePanel.texts.add(new TextFactory("Test", 40));
	...
	/* WHAT IT DOES: Setter method for variable chambered according to parameter
	 * PARAMETERS:
	 * 	chambered - the desired status of whether the current gun is chambered
	 * 	bullet - the specific bullet that was chambered
	 * RETURN: NONE*/
	...
	/* WHAT IT DOES: Getter method for variable chamber
	 * PARAMETERS: NONE
	 * RETURN: 2D Rectangle indicating the hitbox of the chamber*/
