...
//		g2.fill(magDetection);
	 ...
	 * PARAMETERS: NONE
	 * RETURN: Boolean - whether the firing of the gun has succeeded*/
	public boolean fire()
	{
		if (gunLoaded == false)
		{
	...
	/* WHAT IT DOES: Handles the logistics of manual reloading via pulling the gun's pin
	 * PARAMETERS: NONE
	 * RETURN: NONE*/
...
//			wasteBullet();
	...
	/* WHAT IT DOES: Ejects the ejection of the gun's loaded magazine
	 * PARAMETERS: NONE
	 * RETURN: Boolean - if the ejection was successful*/
