...
//		g2.fill(getOpenSlot());
	...
	/* WHAT IT DOES: Getter method for the hitbox of the magazine's opening
	 * PARAMETERS: NONE
	 * RETURN: Hitbox of the magazine's opening*/
	public Rectangle2D.Double getOpenSlot() {
		return openSlot;
	}

	/* WHAT IT DOES: Setter method for dynamically moving the magazine's opening
	 * PARAMETERS: 
	 * 	openSlot - the new opening of the magazine
	 * RETURN: NONE*/
	public void setOpenSlot(Rectangle2D.Double openSlot) {
		this.openSlot = openSlot;
	}

	/* WHAT IT DOES: Getter method of variable loaded 
	 * PARAMETERS: NONE
	 * RETURN: Status of whether the magazine is loaded into a gun*/
	public boolean isLoaded() {
		return loaded;
	}

	/* WHAT IT DOES: Setter method of variable loaded 
	 * PARAMETERS: Desired status of magazine loading
	 * RETURN: NONE*/
	public void setLoaded(boolean loaded) {
		this.loaded = loaded;
	}
	
	/* WHAT IT DOES: Handles animation of magazine falling down 
	 * PARAMETERS: NONE 
	 * RETURN: NONE*/
	...
	/* WHAT IT DOES: Setter method that sets the status of magazine load, and handle necessary
	 * 	variable changes 
	 * PARAMETERS: NONE 
	 * RETURN: NONE*/
