...
public class TextFactory
{
	...
	/* WHAT IT DOES: Draws the text on the screen centered inside the invisible box 
	 * PARAMETERS: 
	 * 	g - Graphics brush
	 * RETURN: NONE*/
...
//		    y = ((rect.height - fontMeasure.getHeight()) / 2) + fontMeasure.getAscent()*3;
	...
	/* WHAT IT DOES: Getter method for variable lifeTime 
	 * PARAMETERS: NONE
	 * RETURN: Double - lifeTime value*/
