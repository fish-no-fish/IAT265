...
public class GunRangePanel extends JPanel implements ActionListener, MouseListener, MouseMotionListener
{
	...
	private boolean endSim; //determines when the player has pressed button to end simulator 
...
//	    y = ((tutRect.height - fontMeasure.getHeight()) / 2) + fontMeasure.getAscent();
	...
	/* WHAT IT DOES: Draws the ending outro screen 
	 * PARAMETERS: 
	 * 	g2 - Graphics2D brush
	 * RETURN: NONE*/
	private void drawEnd(Graphics2D g2)
	{
		...
		g2.setFont(titles);
		g2.setColor(Color.white);
		g2.drawString("Thank you for trying this Gun Range Simulator", WIN_W/2-550, WIN_H/4);

		g2.drawString("Made By: Henry Zhao", WIN_W/2-250, WIN_H/2);

		g2.drawString("Press Replay to play again", WIN_W/2-300, WIN_H/2+400);
	}
